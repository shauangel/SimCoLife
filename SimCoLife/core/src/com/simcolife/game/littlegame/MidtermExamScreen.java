...
public class MidtermExamScreen extends ScreenAdapter {
	...
	public MidtermExamScreen(SimCoGame game,Player player) {
		...
		fontParameter.characters = FreeTypeFontGenerator.DEFAULT_CHARS + "按SPACE離開剩餘時間：得期中考試成績獲得學分";
	...
	public void render(float delta) {
    	...
    	if(currentState == GameState.START_MENU) {
			...
			if(TimeUtils.nanoTime() - startTime < 20000000000L && TimeUtils.nanoTime() - lastDropTime > 250000000) {
				bulletsDrop();
			}
