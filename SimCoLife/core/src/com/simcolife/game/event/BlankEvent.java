...
public class BlankEvent extends ScreenAdapter {
    ...
    private Texture emoji = new Texture(Gdx.files.internal("card/BlankEmojiImg.png"));
	
	public BlankEvent(SimCoGame game) {
		this.game = game;
		setStage();
        ...
        this.fontParameter.characters = FreeTypeFontGenerator.DEFAULT_CHARS + "發呆了一天.按下SPACE回到遊戲";
	...
	public void render(float delta) {
		...
		glyphLayout.setText(font, "發呆了一天...");
