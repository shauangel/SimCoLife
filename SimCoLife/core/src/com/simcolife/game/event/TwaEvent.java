...
public class TwaEvent extends ScreenAdapter {
	...
	public TwaEvent(SimCoGame game) {
		this.game = game;
		setStage();
	//-------get random event--------
		Random r = new Random();
		this.randomE = EventImporter.twaList.get(r.nextInt(EventImporter.twaList.size()));
